...
enum HuggingFaceIntegrationError: LocalizedError {
...
struct HuggingFaceHubDownloader: Downloader {
    ...
    func download(
        ...
        guard let repoID = Repo.ID(rawValue: id) else {
            throw HuggingFaceIntegrationError.invalidRepositoryID(id)
        }
...
struct HuggingFaceBridgeTokenizerLoader: TokenizerLoader {
